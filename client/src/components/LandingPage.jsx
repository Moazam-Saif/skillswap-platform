  ...
  return (
    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-screen w-full grid grid-cols-20 grid-rows-[repeat(10,1fr)] gap-0">
        ...
        <Link className="col-start-6 col-span-2 row-start-9" to="/register"><button className="bg-[#E76F51] text-white px-5 py-3 rounded-3xl text-lg font-medium transition-all duration-300 border border-white/20 shadow-md hover:border-white hover:shadow-lg">
  Login
</button>
</Link>
