...
export default function LandingPage() {
  return (
    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="block md:hidden">
        <div className="h-screen w-full flex flex-col items-center justify-center px-4">
          ...
          <div className="flex flex-col items-center space-y-6 mb-12">
            ...
            {/* Animation Stroke */}
            <div className="w-48 sm:w-56 h-8 flex items-center justify-center">
      ...
      {/* Desktop Layout */}
      <div className="relative z-10 h-screen w-full hidden md:grid grid-cols-20 grid-rows-[repeat(10,1fr)] gap-0">
        {/* SKILL text on left */}
