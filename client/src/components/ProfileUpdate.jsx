...
export default function ProfileUploadPage() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex h-full bg-gray-50" style={{ fontFamily: "'Josefin Sans', sans-serif" }}>
        {/* Error Message */}
        {error && (
      ...
      <div className="lg:hidden bg-gray-50" style={{ fontFamily: "'Josefin Sans', sans-serif" }}>
        {/* Error Message */}
        {error && (
